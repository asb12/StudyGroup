...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	//Table Groups
	static final String KEY_CODE = "Course_Name";    
	static final String KEY_LOCATION = "Location";
	static final String KEY_MAXMEMBERS = "Max_Members";
...
//		return td;
	...
	public void deleteGroup(String groupid) {
	   ...
	   public void deleteTable(String Group) {
		   SQLiteDatabase db = this.getWritableDatabase();
	   ...
	   public Cursor fetchAllGroups() {
		   SQLiteDatabase db = this.getWritableDatabase();
		   Cursor mCursor = db.query(TABLE_GROUP, new String[] { KEY_CODE, KEY_LOCATION, KEY_DESCRIPTION, KEY_MAXMEMBERS}, 
